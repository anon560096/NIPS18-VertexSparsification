...
function min_st_cut{V,E}(g::Graphs.AbstractGraph{V,E},s::V,t::V,capacity::Vector{Float64})
...
function max_flow{V,E}(g::Graphs.AbstractGraph{V,E},s::V,t::V,capacity::Vector{Float64})
  @graph_requires g incidence_list vertex_list
  @assert is_directed(g)
...
function residual_graph{V,E}(g::Graphs.AbstractGraph{V,E},s::V,capacity::Vector{Float64})
...
function residual_graph_sub!{V,E1,E2}(g::Graphs.AbstractGraph{V,E1},r::Graphs.AbstractGraph{V,E2},
  ...
  for edge in out_edges(s,g)
    ...
    d1 = Dict{String,Any}(); d1["capacity"] = capacity[i]; d1["flow"] = 0
    d2 = Dict{String,Any}(); d2["capacity"] = capacity[i]; d2["flow"] = capacity[i]
...
function edmonds_karp_max_flow!{V,E}(g::Graphs.AbstractGraph{V,E},s::V,t::V)
  flow = 0
...
function bfs{V,E}(g::Graphs.AbstractGraph{V,E},s::V,t::V)
...
function dfs{V,E}(g::Graphs.AbstractGraph{V,E},s::V)
  colormap = fill(false,num_vertices(g))
  return dfs!(g,s,colormap)
end

function dfs!{V,E}(g::Graphs.AbstractGraph{V,E},s::V, colormap::Vector{Bool})
